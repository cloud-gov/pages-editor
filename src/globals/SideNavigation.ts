...
export const SideNavigation: GlobalConfig = {
  ...
  admin: {
    ...
    description: 'Configure the side navigation that appears on single pages. This is separate from the main navigation and gives you full control over what appears in the sidebar.',
  },
  fields: [
    {
      name: 'enabled',
