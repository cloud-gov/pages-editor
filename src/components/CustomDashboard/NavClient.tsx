    ...
    <aside className="nav nav--nav-open nav--nav-animate nav--nav-hydrated">
      <div className="nav__scroll" style={{ overscrollBehavior: "auto" }}>
        ...
        <NavGroup label="&#x1F30F; Global Assets">
          ...
          <Link
            href="/admin/collections/not-found-page"
            className={`nav__link ${isActive("/admin/collections/not-found-page") ? "nav__link--active" : ""}`}
          >
        ...
        <div className="nav__controls">
          <Link href="/admin/logout" className="nav__log-out" aria-label="Logout">
            <svg className="icon icon--logout" fill="none" height="20" viewBox="0 0 20 20" width="20">
              <path className="stroke" d="M12 16H14.6667C15.0203 16 15.3594 15.8595 15.6095 15.6095C15.8595 15.3594 16 15.0203 16 14.6667V5.33333C16 4.97971 15.8595 4.64057 15.6095 4.39052C15.3594 4.14048 15.0203 4 14.6667 4H12M7.33333 13.3333L4 10M4 10L7.33333 6.66667M4 10H12" strokeLinecap="square" />
            </svg>
            Logout
          </Link>
        </div>
