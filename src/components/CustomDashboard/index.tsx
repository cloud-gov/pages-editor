    ...
    <div className="grid-container">
      ...
      {user?.isAdmin && (
        <>
          ...
          <Section title="Content Pages and Collections">
            <div className="grid-row grid-gap-2">
              <CardLink
                href="/admin/collections/pages"
                title="Pages"
                description="All sites pages."
                label="View all single pages"
              />
              <CardLink
                href="/admin/collections/collection-entries"
                title="Collection Entries"
                description="All sites pages collection entries."
                label="View all single pages"
              />
              <CardLink
                href="/admin/collections/home-page-site-collection"
                title="Homepages"
                description="A the homepages for the sites."
                label="View homepages"
              />
            </div>
          </Section>
          ...
          <Section title="Users and Roles">
            <div className="grid-row grid-gap-2">
              <CardLink
                ...
                title="Users"
                description="Manage platform users who can access the admin dashboard and their permissions."
                label="View users"
              />
            </div>
          </Section>
          ...
          <Section title="Site Compliance and Security">
            <div className="grid-row grid-gap-2">
              <CardLink
                href="/admin/collections/site-auth-site-collection"
                title="Authorization Forms"
                description="Site ATU forms with information on the sites compliance posture and authorization status."
                label="View ATUs"
              />
            </div>
          </Section>
