// modified from https://github.com/payloadcms/payload/blob/main/packages/ui/src/fields/Array/index.tsx
...
import { Banner, Button, ErrorPill, RenderCustomComponent, FieldDescription, FieldError, FieldLabel } from '@payloadcms/ui'
import { useForm, useFormSubmitted, NullifyLocaleField } from '@payloadcms/ui'
import { extractRowsAndCollapsedIDs, toggleAllRows } from './utilities/rowHelpers'
import { useField, withCondition, useConfig, useDocumentInfo, useLocale, useTranslation } from '@payloadcms/ui'
import { fieldBaseClass } from '@payloadcms/ui'

import { scrollToID } from './utilities/scrollToID'
import { DraggableSortable } from './components/DraggableSortable'
import { DraggableSortableItem } from './components/DraggableSortableItem'
import { ArrayRow } from './components/ArrayRow'

const baseClass = 'array-field'

const ArrayFieldComponent: ArrayFieldClientComponent = (props) => {
  const {
    field: {
      name,
...
const ArrayField = withCondition(ArrayFieldComponent)
