...
export function AccordionBlockCard({
  nodeKey,
  fields,
}: Props) {
  ...
  return (
    <section className="custom-blocks-field__accordion">
      <header className="custom-blocks-field__accordion-header">
        <div className="custom-blocks-field__accordion-header-content">
          ...
          <div className="collapsible__content">
            <div className="render-fields">
              <div className="field-type select" id="field-headingLevel">
                <label
                  htmlFor={`accordion-heading-level-${nodeKey}`}
                ...
                <div className="field-type__wrap">
                  <div className="react-select">
                    <select
                      id={`accordion-heading-level-${nodeKey}`}
                      className="usa-select accordion-heading-level rs_control"
...
{items.length > 0 ? (
        <div className="margin-top-1">
          <div className="custom-blocks-field__accordion-items array-field__draggable-rows">
            {items.map((item, index) => {
              ...
              return (
                <div
                  key={item.id}
                  className={[
                    'custom-blocks-field__accordion-item-wrap custom-blocks-field__item',
                    isDragging &&
                    'custom-blocks-field__accordion-item-wrap--dragging',
                    isDragOver &&
                    'custom-blocks-field__accordion-item-wrap--drag-over',
                  ]
                    .filter(Boolean)
                    .join(' ')}
        ...
        <div className="custom-blocks-field__accordion-empty">
          No accordion items added yet.
        </div>
      )}

      <div className="custom-blocks-field__accordion-actions margin-top-1">
        ...
        <button type="button" onClick={addItem} className="btn array-field__add-row btn--icon btn--icon-style-with-border btn--size-medium btn--icon-position-left btn--withoutPopup btn--style-icon-label btn--withoutPopup">
          ...
          <div className="custom-blocks-field__header-actions">
            ...
            <div className="custom-blocks-field__accordion-meta">
