...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pre_footer_site_collection_pre_footer_type" AS ENUM('big', 'slim');
  CREATE TYPE "public"."connect-section-location" AS ENUM('bottom', 'right');
  CREATE TYPE "public"."enum_pre_footer_site_collection_group_cols" AS ENUM('1', '2', '3', '4');
  ...
  CREATE TYPE "public"."enum__pre_footer_site_collection_v_version_pre_footer_type" AS ENUM('big', 'slim');
  CREATE TYPE "public"."enum__pre_footer_site_collection_v_version_group_cols" AS ENUM('1', '2', '3', '4');
  ...
  CREATE TYPE "public"."enum_pre_footer_pre_footer_type" AS ENUM('big', 'slim');
  CREATE TYPE "public"."enum_pre_footer_group_cols" AS ENUM('1', '2', '3', '4');
  ...
  CREATE TYPE "public"."enum__pre_footer_v_version_pre_footer_type" AS ENUM('big', 'slim');
  CREATE TYPE "public"."enum__pre_footer_v_version_group_cols" AS ENUM('1', '2', '3', '4');
  ...
  CREATE TABLE "pre_footer_site_collection_links_groups" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"group_name" varchar
  ...
  CREATE TABLE "pre_footer_site_collection" (
  	...
  	"pre_footer_type" "enum_pre_footer_site_collection_pre_footer_type",
  	"connect_section_location" "connect-section-location" DEFAULT 'right',
  	"group_cols" "enum_pre_footer_site_collection_group_cols" DEFAULT '1',
  	"site_id" integer,
  ...
  CREATE TABLE "_pre_footer_site_collection_v_version_links_groups" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"group_name" varchar,
  ...
  CREATE TABLE "_pre_footer_site_collection_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_pre_footer_type" "enum__pre_footer_site_collection_v_version_pre_footer_type",
  	"version_connect_section_location" "connect-section-location" DEFAULT 'right',
  	"version_group_cols" "enum__pre_footer_site_collection_v_version_group_cols" DEFAULT '1',
  ...
  CREATE TABLE "pre_footer_links_groups" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"group_name" varchar
  ...
  CREATE TABLE "pre_footer" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"pre_footer_type" "enum_pre_footer_pre_footer_type",
  	"connect_section_location" "connect-section-location" DEFAULT 'right',
  	"group_cols" "enum_pre_footer_group_cols" DEFAULT '1',
  ...
  CREATE TABLE "_pre_footer_v_version_links_groups" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"group_name" varchar,
  ...
  CREATE TABLE "_pre_footer_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"version_pre_footer_type" "enum__pre_footer_v_version_pre_footer_type",
  	"version_connect_section_location" "connect-section-location" DEFAULT 'right',
  	"version_group_cols" "enum__pre_footer_v_version_group_cols" DEFAULT '1',
  ...
  ALTER TABLE "pre_footer_site_collection_links_groups" ADD CONSTRAINT "pre_footer_site_collection_links_groups_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pre_footer_site_collection"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pre_footer_site_collection_v_version_links_groups" ADD CONSTRAINT "_pre_footer_site_collection_v_version_links_groups_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pre_footer_site_collection_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pre_footer_links_groups" ADD CONSTRAINT "pre_footer_links_groups_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pre_footer"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pre_footer_v_version_links_groups" ADD CONSTRAINT "_pre_footer_v_version_links_groups_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pre_footer_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pre_footer_site_collection_links_groups_order_idx" ON "pre_footer_site_collection_links_groups" USING btree ("_order");
  CREATE INDEX "pre_footer_site_collection_links_groups_parent_id_idx" ON "pre_footer_site_collection_links_groups" USING btree ("_parent_id");
  ...
  CREATE INDEX "_pre_footer_site_collection_v_version_links_groups_order_idx" ON "_pre_footer_site_collection_v_version_links_groups" USING btree ("_order");
  CREATE INDEX "_pre_footer_site_collection_v_version_links_groups_parent_id_idx" ON "_pre_footer_site_collection_v_version_links_groups" USING btree ("_parent_id");
  ...
  CREATE INDEX "pre_footer_links_groups_order_idx" ON "pre_footer_links_groups" USING btree ("_order");
  CREATE INDEX "pre_footer_links_groups_parent_id_idx" ON "pre_footer_links_groups" USING btree ("_parent_id");
  ...
  CREATE INDEX "_pre_footer_v_version_links_groups_order_idx" ON "_pre_footer_v_version_links_groups" USING btree ("_order");
  CREATE INDEX "_pre_footer_v_version_links_groups_parent_id_idx" ON "_pre_footer_v_version_links_groups" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "pre_footer_site_collection_links_groups" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "_pre_footer_site_collection_v_version_links_groups" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "pre_footer_links_groups" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "_pre_footer_v_version_links_groups" DISABLE ROW LEVEL SECURITY;
  ...
  DROP TABLE "pre_footer_site_collection_links_groups" CASCADE;
  ...
  DROP TABLE "_pre_footer_site_collection_v_version_links_groups" CASCADE;
  ...
  DROP TABLE "pre_footer_links_groups" CASCADE;
  ...
  DROP TABLE "_pre_footer_v_version_links_groups" CASCADE;
  ...
  DROP TYPE "public"."enum_pre_footer_site_collection_pre_footer_type";
  DROP TYPE "public"."connect-section-location";
  DROP TYPE "public"."enum_pre_footer_site_collection_group_cols";
  ...
  DROP TYPE "public"."enum__pre_footer_site_collection_v_version_pre_footer_type";
  DROP TYPE "public"."enum__pre_footer_site_collection_v_version_group_cols";
  ...
  DROP TYPE "public"."enum_pre_footer_pre_footer_type";
  DROP TYPE "public"."enum_pre_footer_group_cols";
  DROP TYPE "public"."enum_pre_footer_status";
  DROP TYPE "public"."enum__pre_footer_v_blocks_collection_link_page";
  DROP TYPE "public"."enum__pre_footer_v_version_pre_footer_type";
  DROP TYPE "public"."enum__pre_footer_v_version_group_cols";
