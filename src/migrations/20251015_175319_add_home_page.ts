...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_home_page_site_collection_blocks_text_block_bg_color" AS ENUM('white', 'gray-50', 'blue-50', 'green-50');
  ...
  CREATE TYPE "public"."enum__home_page_site_collection_v_blocks_text_block_bg_color" AS ENUM('white', 'gray-50', 'blue-50', 'green-50');
  ...
  CREATE TYPE "public"."enum_home_page_blocks_text_block_bg_color" AS ENUM('white', 'gray-50', 'blue-50', 'green-50');
  ...
  CREATE TYPE "public"."enum__home_page_v_blocks_text_block_bg_color" AS ENUM('white', 'gray-50', 'blue-50', 'green-50');
  ...
  CREATE TABLE "home_page_site_collection_blocks_text_block" (
  	...
  	"title" varchar,
  	"content" jsonb,
  	"bg_color" "enum_home_page_site_collection_blocks_text_block_bg_color" DEFAULT 'white',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_home_page_site_collection_v_blocks_text_block" (
  	...
  	"title" varchar,
  	"content" jsonb,
  	"bg_color" "enum__home_page_site_collection_v_blocks_text_block_bg_color" DEFAULT 'white',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "home_page_blocks_text_block" (
  	...
  	"title" varchar,
  	"content" jsonb,
  	"bg_color" "enum_home_page_blocks_text_block_bg_color" DEFAULT 'white',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_home_page_v_blocks_text_block" (
  	...
  	"title" varchar,
  	"content" jsonb,
  	"bg_color" "enum__home_page_v_blocks_text_block_bg_color" DEFAULT 'white',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  ALTER TABLE "home_page_site_collection" ADD CONSTRAINT "home_page_site_collection_seo_og_image_id_media_id_fk" FOREIGN KEY ("seo_og_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_home_page_site_collection_v" ADD CONSTRAINT "_home_page_site_collection_v_version_seo_og_image_id_media_id_fk" FOREIGN KEY ("version_seo_og_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "home_page_site_collection_seo_seo_og_image_idx" ON "home_page_site_collection" USING btree ("seo_og_image_id");
  ...
  CREATE INDEX "_home_page_site_collection_v_version_seo_version_seo_og_image_idx" ON "_home_page_site_collection_v" USING btree ("version_seo_og_image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_home_page_site_collection_fk";
  ...
  DROP TYPE "public"."enum_home_page_site_collection_blocks_text_block_bg_color";
  ...
  DROP TYPE "public"."enum__home_page_site_collection_v_blocks_text_block_bg_color";
  ...
  DROP TYPE "public"."enum_home_page_blocks_text_block_bg_color";
  DROP TYPE "public"."enum_home_page_status";
  DROP TYPE "public"."enum__home_page_v_blocks_hero_cta_button_style";
  DROP TYPE "public"."enum__home_page_v_blocks_text_block_bg_color";
